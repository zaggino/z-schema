...
var schemaCombinations = {
  'authorizationObject.json': [oauth2GrantType, authorizationObject],
  'infoObject.json': [infoObject],
  'oauth2GrantType.json': [oauth2GrantType],
  'resourceObject.json': [resourceObject],
  'resourceListing.json': [resourceObject, infoObject, oauth2GrantType, authorizationObject, resourceListing],
};
