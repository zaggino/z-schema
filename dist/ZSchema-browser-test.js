...
},{"../../src/ZSchema":"C768cZ","../files/draft-04-schema.json":9,"../jsonSchemaTestSuite/remotes/folder/folderInteger.json":10,"../jsonSchemaTestSuite/remotes/integer.json":11,"../jsonSchemaTestSuite/remotes/subSchemas.json":12}],43:[function(require,module,exports){
"use strict";
...
},{"../../src/ZSchema":"C768cZ","../files/draft-04-schema.json":9,"../jsonSchemaTestSuite/remotes/folder/folderInteger.json":10,"../jsonSchemaTestSuite/remotes/integer.json":11,"../jsonSchemaTestSuite/remotes/subSchemas.json":12,"../jsonSchemaTestSuite/tests/draft4/additionalItems.json":13,"../jsonSchemaTestSuite/tests/draft4/additionalProperties.json":14,"../jsonSchemaTestSuite/tests/draft4/allOf.json":15,"../jsonSchemaTestSuite/tests/draft4/anyOf.json":16,"../jsonSchemaTestSuite/tests/draft4/definitions.json":17,"../jsonSchemaTestSuite/tests/draft4/dependencies.json":18,"../jsonSchemaTestSuite/tests/draft4/enum.json":19,"../jsonSchemaTestSuite/tests/draft4/items.json":20,"../jsonSchemaTestSuite/tests/draft4/maxItems.json":21,"../jsonSchemaTestSuite/tests/draft4/maxLength.json":22,"../jsonSchemaTestSuite/tests/draft4/maxProperties.json":23,"../jsonSchemaTestSuite/tests/draft4/maximum.json":24,"../jsonSchemaTestSuite/tests/draft4/minItems.json":25,"../jsonSchemaTestSuite/tests/draft4/minLength.json":26,"../jsonSchemaTestSuite/tests/draft4/minProperties.json":27,"../jsonSchemaTestSuite/tests/draft4/minimum.json":28,"../jsonSchemaTestSuite/tests/draft4/multipleOf.json":29,"../jsonSchemaTestSuite/tests/draft4/not.json":30,"../jsonSchemaTestSuite/tests/draft4/oneOf.json":31,"../jsonSchemaTestSuite/tests/draft4/optional/bignum.json":32,"../jsonSchemaTestSuite/tests/draft4/optional/format.json":33,"../jsonSchemaTestSuite/tests/draft4/pattern.json":34,"../jsonSchemaTestSuite/tests/draft4/patternProperties.json":35,"../jsonSchemaTestSuite/tests/draft4/properties.json":36,"../jsonSchemaTestSuite/tests/draft4/ref.json":37,"../jsonSchemaTestSuite/tests/draft4/refRemote.json":38,"../jsonSchemaTestSuite/tests/draft4/required.json":39,"../jsonSchemaTestSuite/tests/draft4/type.json":40,"../jsonSchemaTestSuite/tests/draft4/uniqueItems.json":41}],44:[function(require,module,exports){
/*jshint -W030 */
...
describe("ZSchemaTestSuite", function () {
    ...
    it("should contain 8 files", function () {
        expect(testSuiteFiles.length).toBe(8);
    });
