...
},{"../../src/ZSchema":"C768cZ","../files/draft-04-schema.json":8,"../jsonSchemaTestSuite/remotes/folder/folderInteger.json":9,"../jsonSchemaTestSuite/remotes/integer.json":10,"../jsonSchemaTestSuite/remotes/subSchemas.json":11}],42:[function(require,module,exports){
"use strict";
...
},{"../../src/ZSchema":"C768cZ","../files/draft-04-schema.json":8,"../jsonSchemaTestSuite/remotes/folder/folderInteger.json":9,"../jsonSchemaTestSuite/remotes/integer.json":10,"../jsonSchemaTestSuite/remotes/subSchemas.json":11,"../jsonSchemaTestSuite/tests/draft4/additionalItems.json":12,"../jsonSchemaTestSuite/tests/draft4/additionalProperties.json":13,"../jsonSchemaTestSuite/tests/draft4/allOf.json":14,"../jsonSchemaTestSuite/tests/draft4/anyOf.json":15,"../jsonSchemaTestSuite/tests/draft4/definitions.json":16,"../jsonSchemaTestSuite/tests/draft4/dependencies.json":17,"../jsonSchemaTestSuite/tests/draft4/enum.json":18,"../jsonSchemaTestSuite/tests/draft4/items.json":19,"../jsonSchemaTestSuite/tests/draft4/maxItems.json":20,"../jsonSchemaTestSuite/tests/draft4/maxLength.json":21,"../jsonSchemaTestSuite/tests/draft4/maxProperties.json":22,"../jsonSchemaTestSuite/tests/draft4/maximum.json":23,"../jsonSchemaTestSuite/tests/draft4/minItems.json":24,"../jsonSchemaTestSuite/tests/draft4/minLength.json":25,"../jsonSchemaTestSuite/tests/draft4/minProperties.json":26,"../jsonSchemaTestSuite/tests/draft4/minimum.json":27,"../jsonSchemaTestSuite/tests/draft4/multipleOf.json":28,"../jsonSchemaTestSuite/tests/draft4/not.json":29,"../jsonSchemaTestSuite/tests/draft4/oneOf.json":30,"../jsonSchemaTestSuite/tests/draft4/optional/bignum.json":31,"../jsonSchemaTestSuite/tests/draft4/optional/format.json":32,"../jsonSchemaTestSuite/tests/draft4/pattern.json":33,"../jsonSchemaTestSuite/tests/draft4/patternProperties.json":34,"../jsonSchemaTestSuite/tests/draft4/properties.json":35,"../jsonSchemaTestSuite/tests/draft4/ref.json":36,"../jsonSchemaTestSuite/tests/draft4/refRemote.json":37,"../jsonSchemaTestSuite/tests/draft4/required.json":38,"../jsonSchemaTestSuite/tests/draft4/type.json":39,"../jsonSchemaTestSuite/tests/draft4/uniqueItems.json":40}],43:[function(require,module,exports){
/*jshint -W030 */
...
describe("ZSchemaTestSuite", function () {
    ...
    it("should contain 7 files", function () {
        expect(testSuiteFiles.length).toBe(7);
    });
