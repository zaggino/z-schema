...
ZSchema.setRemoteReference('http://json-schema.org/draft-06/schema', Draft6Schema, { version: 'none' });
ZSchema.setRemoteReference('http://json-schema.org/draft-06/hyper-schema', Draft6HyperSchema, { version: 'none' });
ZSchema.setRemoteReference('http://json-schema.org/draft-06/links', Draft6Links, { version: 'none' });
